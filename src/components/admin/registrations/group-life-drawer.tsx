...
interface GroupLifeDrawerProps {
  registration: any;
  open: boolean;
...
export function GroupLifeDrawer({
  registration,
  open,
  onOpenChange,
  mode,
}: GroupLifeDrawerProps) {
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-blue-100 text-sm mt-1">
                    RC: {registration.rc_number} • Submitted{" "}
              ...
              <div className="flex items-center gap-3">
                ...
                <Badge
                  ...
                  className={cn(
                    "px-3 py-1 text-sm",
                    "bg-white/20 text-white border-white/30",
                    verificationStatusStyles[registration.verification_status as keyof typeof verificationStatusStyles]
                  )}
                >
                  {registration.verification_status === 'not_verified' ? 'Not Verified' : 'Verified'}
                </Badge>
              </div>
              ...
              <TabsContent value="details" className="mt-0 space-y-6">
                ...
                <div className="grid grid-cols-4 gap-4">
                  ...
                  <div className="bg-green-50 p-4 rounded-lg text-center">
                    ...
                    <p className="text-2xl font-bold">{registration.employees || 'N/A'}</p>
                  ...
                  <div className="space-y-6">
                    <SectionCard title="Company Information">
                      ...
                      <InfoRow
                        ...
                        value={registration.secondary_phone}
                        icon={Phone}
                      />
                      <InfoRow
                        label="Address"
                        value={`${registration.house_address || ''}, ${registration.city || ''}, ${registration.state || ''}, ${registration.country || ''}`}
                        icon={MapPin}
                      />
                    </SectionCard>
                    ...
                    <SectionCard title="Director Information">
                      <InfoRow
                        label="Name"
                        value={registration.director_name}
                        icon={User}
                      />
                      <InfoRow
              ...
              <TabsContent value="documents" className="mt-0">
                <SectionCard title="Uploaded Documents">
                  <div className="space-y-3">
                    ...
                    />
                    <DocumentCard
                      name="Director's Identity Card"
                      date={format(new Date(registration.submitted_at), 'MMM d, yyyy')}
                      status={registration.verification_status}
                    />
                    <DocumentCard
                      name="Director's Passport Photograph"
                      date={format(new Date(registration.submitted_at), 'MMM d, yyyy')}
                      status={registration.verification_status}
                    />
                  ...
                  <div className="space-y-4">
                    ...
                    {registration.account_status === 'invited' && (
                      <TimelineItem
                        ...
                        date={registration.approved_at}
                        description="Invitation email sent to company admin"
                      />
                    )}
                    ...
                    {registration.account_status === 'active' && (
                      <TimelineItem
                        ...
                        description="Company admin set up password and activated account"
                        isLast={true}
                      />
                    )}
          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="space-y-3">
              <p>
                ...
                <span className="font-semibold">{registration?.company_name}</span>?
              </p>
