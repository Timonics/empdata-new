...
import { EmployeeGroupLifeDrawer } from "./employee-group-life-drawer";
import { EmployeeGroupLifeStats } from "./employee-group-life-stats";
...
export function EmployeeGroupLifeRegistrations() {
  // Pagination state
  ...
  const { data, isLoading, refetch, isFetching } = useEmployeeRegistrations(
    filters,
    currentPage,
  );

  console.log("Employee Group Life Data:", data);
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 border-b pb-2">
          ...
          <Button
            variant={
              filters.status === "pending_approval" ? "default" : "ghost"
            }
            size="sm"
            onClick={() => {
      ...
      <div className="rounded-md border bg-white">
        <DataTable
          ...
          emptyMessage="No employee group life registrations found"
        />
      </div>
            ...
            <AlertDialogDescription asChild>
              <div className="space-y-3">
                <p>
                  ...
                  from <span className="font-semibold">{selectedRegistration?.company_name}</span>?
                </p>
                <p className="text-sm text-gray-600">
                  This will mark the registration as approved. You can then send
                  an invitation to the employee to create their account.
                </p>
              </div>
            </AlertDialogDescription>
          </AlertDialogHeader>
