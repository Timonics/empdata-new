...
import { Building2, Globe, MapPin, Phone, Mail, Hash, ChevronDown } from 'lucide-react';
...
const states = [
  'Lagos', 'Abuja FCT', 'Rivers', 'Oyo', 'Kano', 'Kaduna', 'Delta', 'Edo',
  'Ogun', 'Anambra', 'Enugu', 'Cross River', 'Others'
];
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-sm text-gray-500">
          Tell us about your company. This information will be used for your insurance policy.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {/* TIN (Optional) */}
        <div className="space-y-2">
          <label className="text-sm font-medium text-gray-700">Tax Identification Number (Optional)</label>
          <div className="relative">
            <Hash className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
            <input
              type="text"
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            >
              <span className={onBoardingData?.state ? 'text-gray-900' : 'text-gray-400'}>
                {onBoardingData?.state || 'Select state'}
              </span>
              <ChevronDown className={cn("w-4 h-4 text-gray-400", openState && "rotate-180")} />
            </button>
            {openState && (
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            >
              <span className={onBoardingData?.country ? 'text-gray-900' : 'text-gray-400'}>
                {onBoardingData?.country || 'Select country'}
              </span>
              <ChevronDown className={cn("w-4 h-4 text-gray-400", openCountry && "rotate-180")} />
            </button>
            {openCountry && (
